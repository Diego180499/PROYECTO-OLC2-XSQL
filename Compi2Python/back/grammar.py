...
import sys
from back.models.VariableType import VariableType
from back.models.ValueType import ValueType
from back.models.Value import Value
from back.models.DeclareStatement import DeclareStatement
from back.models.UnaryOperation import UnaryOperation
from back.models.OperationType import OperationType
from back.models.BinaryOperation import BinaryOperation
from back.models.SetStatement import SetStatement
from back.models.Assignment import Assignment
from back.models.ElseStatement import ElseStatement
from back.models.WhenStatement import WhenStatement
from back.models.IfStatement import IfStatement
from back.models.WhileStatement import WhileStatement
...
def p_create_function_statement(t):
    'create_function_statement  : CREATE FUNCTION NAME L_PAREN parameters R_PAREN RETURN type AS BEGIN statements RETURN a END SEMICOLON'
...
### if ternario 2
def p_if_statement_4(t):
    'if_statement   : IF L_PAREN a COMMA a COMMA a R_PAREN  AS NAME'
    t[0] = IfStatement(t.lineno(1), find_column(input, t.slice[1]), t[3], [t[5]], [t[7]])
### SE AGREGÓ ESTE OTRO TIPO DE IF TERNARIO, YA QUE PUEDE IR EN EL SELECT
### Y DEBE ASIGNARLE LA EXPRESION RESULTANTE DEL IF A LA COLUMNA (NAME) QUE ESTÁ AGREGADO
